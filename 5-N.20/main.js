document.addEventListener("DOMContentLoaded", function () {
    ...
    let squareRootsButton = document.querySelector('.square-roots-button');
    let autoTestsButton = document.querySelector('.auto-tests-button');
    ...
    squareRootsButton.addEventListener('click', ttt);
    autoTestsButton.addEventListener('click', squareRootsTests);
});